...
function AreaChartStacked(props) {
...
function D3AreaChartStacked(
  ...
  if (areaColor === undefined) areaColor = d3.schemeSet2; // d3.quantize(t => d3.interpolateSpectral(t * 1.3 + 0.1) , keysOfGroups.length);
  if (strokeColor === undefined) strokeColor = areaColor;

  const areaColorScale = d3.scaleOrdinal(keysOfGroups, areaColor),
