...
class AreaChartGroup extends Component {
  ...
  componentDidMount(){
    ...
    const element = this.element, area = new D3AreaChartGroup(element); 
...
class D3AreaChartGroup {
  ...
  render(data, attr) {
    ...
    if (areaColor === undefined)
      areaColor = d3.quantize(t => d3.interpolateSpectral(t * 0.8 + 0.1) , keysOfGroups.length);
    if (strokeColor === undefined)
      strokeColor = areaColor;

    const
      areaColorScale = d3.scaleOrdinal(keysOfGroups, areaColor),
